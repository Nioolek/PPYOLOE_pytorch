...
from ppyoloe.assigner import ATSSAssigner, TaskAlignedAssigner
...
class ExpE(BaseExp):
    ...
    def get_model(self):
        from ppyoloe.models import CSPResNet, CustomCSPPAN, PPYOLOE, PPYOLOEHead
    ...
    def preprocess(self, inputs, targets, tsize):
        ...
        # yolox默认输入是xywh，而ppyoloe默认使用xyxy。
